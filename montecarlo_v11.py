# ════════════════════════════════════════════════════════════
#  MONTE CARLO RISK ENGINE v11 — Institutional stress testing
...
#
#  Usage: python montecarlo_v11.py   (needs backtest_master_v10.json)
# ════════════════════════════════════════════════════════════
...
def run():
    with open("backtest_master_v10.json") as f:
        trades = json.load(f)
